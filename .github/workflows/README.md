...
- Python API tests (18)
- Market package platform, job-stream, auction, loop and command-line tests (27)
...
| Market package | 27 | CI runner; platforms, jobs, trace preparation, mechanisms, market loop and command line |
