...
- Python API tests (27)
- Market package adapter, market model, VCG, controller and learned tests (47)
...
| Market package | 47 | CI runner; adapters, market model, VCG, controller, learned (skipped without torch) |
